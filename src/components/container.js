                                                ...
                                                <div className="item">
                                                    <div className="row">
                                                        <div className="col-sm-12 text-left">
                                                                                                        <p><Link to="/detail-news?id=11">TUYỂN LẬP TRÌNH VIÊN (JAVA/.Net)</Link></p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="item">
                                                    <div className="row">
                                                        <div className="col-sm-12 text-left">
                                                                                                        <p><Link to="/detail-news?id=10">TUYỂN DỤNG PHIÊN DỊCH TIẾNG NHẬT</Link></p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="item active">
                                                    <div className="row">
                                                        <div className="col-sm-12 text-left">
                                                                                                        <p><Link to="/detail-news?id=9">THÔNG BÁO TUYỂN DỤNG BIÊN PHIÊN DỊCH - NHÂN VIÊN CHÍNH THỨC FULLTIME</Link></p>
                                                        </div>
                                                    </div>
                                                </div>
                                            <div className="item">
                                                <div className="row">
                                                    <div className="col-sm-12 text-left">
                                                                                                <p><Link to="/detail-news?id=4">TUYỂN DỤNG PHIÊN DỊCH TIẾNG NHẬT</Link></p>
                                                    </div>
                                                </div>
                                            </div>
                                                            </div>
